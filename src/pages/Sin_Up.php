...
<html>
    ...
    <meta lang="en">
    <meta charset="utf-8">
    <link rel="stylesheet" href="../assets/css/Sin_Up.css">
    ...
    <body>
        ...
        <form action="<?php $_ assets/images['SCRIPT_NAME'] ?>" method="POST" class="form">
            <img src=" ../assets/images/images/admin_notes/dashboard-widget-setup.png" class="img">
            <h3>Create Your account</h3>
            <div class=" grob_one">
                <input type="text" name="user_name" placeholder="user name ">
                <input type=" text" name="user_gmail" placeholder="somsing@gmail">
                <input type="text" name="user_phone" placeholder="123456789">
            </div>
            <div class="grob_tow">
                <input type="text" name="user_password" placeholder="password">
                <input type="text" name="user_repassword" placeholder="re password">
                <input type="text" name="user_gender" placeholder="gender">
            </div>
            <button>Sin Up</button>
            you have account? <a href="Sin_Up.html">log in</a>
            <br>
            <hr>
            <h5> wlcome in youe moll</h5>
            <hr>
